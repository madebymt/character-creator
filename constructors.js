...
const badguy = new BadGuy("Hans Gruber","Freddy","That's a beautiful suit....I'd hate to ruin it.")
console.log(badguy)


// 2) Give the BadGuy constructor the ability to take a parameter of "name".

// function BadGuy(name,badDude,scaryGuy,tagLine) {
//     this.name = name;
//     this.badDude = badDude;
//     this.scaryGuy = scaryGuy;
...
let badDude = new BadGuy ("Han Gruber", "That's a beautiful suit....I'd hate to ruin it.")
...
// 5) Give the BadGuy constructor a tagLine method that will take the parameter
// "tagline" and say the tag line when prompted by a new instance in the
//following format: console.log("this.name" + " said " + this.tagline); ...
